if ($("body").not(".is-mobile").hasClass("ep-magic-cursor")) {
  $(".ep-magnetic-item").wrap('<div class="ep-magnetic-wrap"></div>');

  if ($("a.ep-magnetic-item").length) {
    $("a.ep-magnetic-item").addClass("not-hide-cursor");
  }
