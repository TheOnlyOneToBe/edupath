                    ...
                    <div class="container ep-container">
                        ...
                        <div class="row mb-4">
                            <div class="col-12 text-end">
                                <a href="../add/add_utilisateur.php" class="ep-btn ep-btn-primary">
                                    ...
                                    <div class="ep-blog__card wow fadeInUp" data-wow-delay=".3s" data-wow-duration="1s">
                                        <div class="ep-blog__info">
                                            ...
                                            <div class="ep-blog__content">
                                                <a href="../view/view_utilisateur.php?id=<?php echo $utilisateur['id_utilisateur']; ?>"
                                                ...
                                                <div class="ep-blog__btn d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        <a href="../edit/edit_utilisateur.php?id=<?php echo $utilisateur['id_utilisateur']; ?>"
