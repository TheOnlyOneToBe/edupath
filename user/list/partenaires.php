                    ...
                    <div class="container ep-container">
                        ...
                        <div class="row mb-4">
                            <div class="col-12 text-end">
                                <a href="../add/add_partenaire.php" class="ep-btn ep-btn-primary">
                                    ...
                                    <div class="ep-blog__info">
                                        ...
                                        <div class="ep-blog__content">
                                            <h5 class="ep-blog__title">
                                               <a href="../view/view_partenaire.php?id=<?php echo $partenaire['id_partenaire']; ?>"> <?php echo htmlspecialchars($partenaire['nom']); ?></a>
                                            </h5>
